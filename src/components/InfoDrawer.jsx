...
const InfoDrawer = ({ selectedPart, isOpen, onClose, isAlwaysVisible }) => {
    // Check if this is database data or mock data
    const isDatabaseData = selectedPart?.partData && selectedPart.partData.specifications;

    // If always visible mode, always render the drawer
    // Otherwise, only render when open and has selected part
