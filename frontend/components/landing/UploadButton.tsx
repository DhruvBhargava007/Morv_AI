      ...
      <div className="flex flex-col items-center justify-center h-full gap-6">
        ...
        <div className="text-center">
          <button
            ...
            className="px-8 py-4 bg-gray-800 hover:bg-gray-700 text-gray-200 hover:text-white font-medium rounded-md border border-gray-700 hover:border-gray-600 transition-colors duration-200 flex items-center gap-3 mx-auto"
          >
